...
int ppm1 = 18;  //channel 1 connect to T14SG Reciever channel No.1 PITCH (interrupts: numbers 5)
int ppm2 = 19;  //channel 2 connect to T14SG Reciever channel No.2 YAW (interrupts: numbers 4)
...
void setup() {
        ...
        // 电平变化即触发中断
        attachInterrupt(5, rc1, CHANGE);    
        attachInterrupt(4, rc2, CHANGE);    
