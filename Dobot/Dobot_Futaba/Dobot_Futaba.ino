...
int valuex, valuey, valuez, zflag, flag, value = 0;
...
//                  }
                 ...
                 if(valuex<400)
                 {
                  gJOGCoordinateParams.velocity[0] = 400-valuex;
                   gJOGCmd.cmd = AP_DOWN;
                  value=1;
                 }
                 else if(valuex>600)
                 {
                  gJOGCoordinateParams.velocity[0] = valuex-600;
                  gJOGCmd.cmd = AN_DOWN;
                  value=2;
                 }
                  if(valuey<400)
                 {
                   gJOGCoordinateParams.velocity[1] = 400-valuey;
                  gJOGCmd.cmd = BN_DOWN;
                  value=3;
                 }
                 else if(valuey>600)
                 {
                   gJOGCoordinateParams.velocity[1] = valuey-600;
                  gJOGCmd.cmd = BP_DOWN;
                  value=4;
                 }
