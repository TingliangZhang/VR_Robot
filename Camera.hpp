...
#include <C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v9.1\include\cuda.h>
...
namespace sl {
     ...
     */
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ Pose {
        friend class CameraMemberHandler;
        friend class Camera;
        ZED_SDK_VERSION_ATTRIBUTE
    public:
    ...
    */
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ IMUData : Pose {
        friend class CameraMemberHandler;
        friend class Camera;
        ZED_SDK_VERSION_ATTRIBUTE
    ...
    public:
         ...
         */
        SL_DEPRECATED(timeStamp getCameraTimestamp());
         ...
         */
        SL_DEPRECATED(timeStamp getCurrentTimestamp());
         ...
         */
        SL_DEPRECATED(static int isZEDconnected());
